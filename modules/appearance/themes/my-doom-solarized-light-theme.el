;;; my-doom-solarized-light-theme.el --- inspired by Atom One Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup my-doom-solarized-light-theme nil
  "Options for the `my-doom-solarized-light' theme."
  :group 'doom-themes)

(defcustom my-doom-solarized-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'my-doom-solarized-light-theme
  :type 'boolean)

(defcustom my-doom-solarized-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'my-doom-solarized-light-theme
  :type 'boolean)

(defcustom my-doom-solarized-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme my-doom-solarized-light
  ...
  (
   ...
   (bg         '("#f9fff5" "#f9fff5" "white"        ))
   (fg         '("#657b82" "#657b82" "black"        ))
   ...
   (base1      '("#FCF8ED" "#FCF8ED" "brightblack"  ))
   (base2      '("#FCF7E8" "#FCF7E8" "brightblack"  ))
   (base3      '("#e3f2d0" "#e3f2d0" "brightblack"  ))
   (base4      '("#d2e2d0" "#d2e2d0" "brightblack"  ))
   (base5      '("#d6ded6" "#d6ded6" "brightblack"  ))
   (base6      '("#b6b7a9" "#b6b7a9" "brightblack"  ))
   (base7      '("#98a4a4" "#98a4a4" "brightblack"  ))
   (base8      '("#727C7C" "#727C7C" "black"        ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if my-doom-solarized-light-brighter-comments
   ...
   ;; custom categories
   (-modeline-bright my-doom-solarized-light-brighter-modeline)
   (-modeline-pad
    (when my-doom-solarized-light-padded-modeline
      (if (integerp my-doom-solarized-light-padded-modeline) my-doom-solarized-light-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if my-doom-solarized-light-brighter-comments
   ...
   (markdown-header-face :inherit 'bold :foreground "#a3a3ff")
   ...
   ;;;; orderless
   (orderless-match-face-0 :foreground blue :background base3 :weight 'bold)
   (orderless-match-face-1 :foreground magenta :background base3 :weight 'bold)
   (orderless-match-face-2 :foreground green   :background base3 :weight 'bold)
   (orderless-match-face-3 :foreground yellow  :background base3 :weight 'bold)
   ;;;; ivy-posframe
...
;;; my-doom-solarized-light-theme.el ends here
