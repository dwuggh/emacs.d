;;; dwuggh-doom-solarized-light-theme.el --- inspired by Atom One Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup dwuggh-doom-solarized-light-theme nil
  "Options for the `dwuggh-doom-solarized-light' theme."
  :group 'doom-themes)

(defcustom dwuggh-doom-solarized-light-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dwuggh-doom-solarized-light-theme
  :type 'boolean)

(defcustom dwuggh-doom-solarized-light-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dwuggh-doom-solarized-light-theme
  :type 'boolean)

(defcustom dwuggh-doom-solarized-light-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme dwuggh-doom-solarized-light
  ...
  (
   ...
   (base3      '("#F2EADE" "#F2EADE" "brightblack"  ))
   (base4      '("#E5DBCD" "#E5DBCD" "brightblack"  ))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if dwuggh-doom-solarized-light-brighter-comments
   ...
   ;; custom categories
   (-modeline-bright dwuggh-doom-solarized-light-brighter-modeline)
   (-modeline-pad
    (when dwuggh-doom-solarized-light-padded-modeline
      (if (integerp dwuggh-doom-solarized-light-padded-modeline) dwuggh-doom-solarized-light-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if dwuggh-doom-solarized-light-brighter-comments
   ...
   (ivy-current-match :background base3 :distant-foreground fg)
   ...
   ;;;; orderless
   (orderless-match-face-0 :foreground blue :background base4 :weight 'bold)
   (orderless-match-face-1 :foreground magenta :background base4 :weight 'bold)
   (orderless-match-face-2 :foreground green   :background base4 :weight 'bold)
   (orderless-match-face-3 :foreground yellow  :background base4 :weight 'bold)
   ;;;; ivy-posframe
...
;;; dwuggh-doom-solarized-light-theme.el ends here
